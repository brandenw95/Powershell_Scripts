...
$ExportResult = ""   
$ExportResults = @()  
$RetrieveOperation = "SoftDelete,HardDelete,MoveToDeletedItems"
...
{ 
    ...
    Search-UnifiedAuditLog -StartDate $CurrentStart -EndDate $CurrentEnd -Operations $RetrieveOperation -SessionId s -SessionCommand ReturnLargeSet -ResultSize 5000 | ForEach-Object {
...
else
{
    ...
    {
        Write-Host "`nThe Output file is available in:" -NoNewline -ForegroundColor Yellow; Write-Host $OutputCSV 
